...
$(function() {
        ...
        switch (true) {
            ...
            case (tag.indexOf('switchmenu') != -1):
				...
				if(typed !== null)
					...
					if($("#hitokoto").data('st') == true){
						$.get("https://hitokoto.jp/", function (data) {
						var data = data;
            ...
            case - 1 != tag.indexOf("comment"): 
				if($('#gitalk-container').data('enable') == true){
					...
					$('#gitalk-container').html("Comments");
				}
                return false;
                break;
            default:
    ...
    console.log("%c Github %c","background:#24272A; color:#ffffff","","https://instagram.com/mas.faishal")
})
